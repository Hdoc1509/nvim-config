  ...
  require('nightfox').setup({
    ...
    groups = {
      ...
      all = {
        ...
        FolderCommand = { fg = COLORS['light-blue-500'] },
        ...
        FolderEvent = { fg = COLORS['yellow-700'] },
        ...
        FolderHelper = { fg = COLORS['lime-700'] },
        FolderHome = { fg = COLORS['red-A200'] },
        FolderHook = { fg = COLORS['deep-purple-400'] },
        ...
        FolderState = { fg = COLORS['light-green-400'] },
